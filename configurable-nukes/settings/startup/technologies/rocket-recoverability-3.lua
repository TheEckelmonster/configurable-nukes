...
local technology = {
        {
        setting = "ROCKET_RECOVERABILITY_3",
        name = "rocket-recoverability-3",
        count = {
            ["default"] = 10000,
            ["space-age"] = 10000,
            ["space-exploration"] = 10000,
        },
        research_time = 60,
        prerequisites = {
            "cn-rocket-recoverability-2",
        },
        ingredients = {
...
if (cn_avionics_active or cn_materials_active or cn_propulsion_active) then
    if (cn_avionics_active) then
        count = count + 1
        table.insert(technology[1].prerequisites, "cn-avionics-9")
    end
