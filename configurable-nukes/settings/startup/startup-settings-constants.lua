...
__Data_Utils.foreach(function(params)
    if (params and params.setting) then startup_settings_constants.settings[params.setting] = params end
end, __Data_Utils.unpack(require("settings.startup.items.target-combinator")))
__Data_Utils.foreach(function(params)
    if (params and params.setting) then startup_settings_constants.settings[params.setting] = params end
end, __Data_Utils.unpack(require("settings.startup.recipes.target-combinator")))

--[[ Target-Combinator program & reformat recipes ]]
__Data_Utils.foreach(function(params)
    if (params and params.setting) then startup_settings_constants.settings[params.setting] = params end
end, __Data_Utils.unpack(require("settings.startup.recipes.target-combinator-recipes")))
...
end, __Data_Utils.unpack(require("settings.startup.technologies.mirvs")))

--[[ rocket-recoverability ]]
__Data_Utils.foreach(function(params)
    if (params and params.setting) then startup_settings_constants.settings[params.setting] = params end
end, __Data_Utils.unpack(require("settings.startup.technologies.rocket-recoverability-1")))

__Data_Utils.foreach(function(params)
    if (params and params.setting) then startup_settings_constants.settings[params.setting] = params end
end, __Data_Utils.unpack(require("settings.startup.technologies.rocket-recoverability-2")))

__Data_Utils.foreach(function(params)
    if (params and params.setting) then startup_settings_constants.settings[params.setting] = params end
end, __Data_Utils.unpack(require("settings.startup.technologies.rocket-recoverability-3")))
...
if (sa_active) then
    ...
    startup_settings_constants.settings.TARGET_COMBINATOR_CRAFTING_MACHINE.default_value = "electronics-with-fluid"
...
for _, setting in ipairs({
    ...
    { recipe = "PAYLOADER_FUEL_RECIPE",   result = "PAYLOADER_FUEL_RESULTS", },
    { recipe = "PAYLOADER_UNFUEL_RECIPE", result = "PAYLOADER_UNFUEL_RESULTS", },
    ...
    --[[ Target Combinator]]
    { recipe = "TARGET_COMBINATOR_RECIPE",                result = "TARGET_COMBINATOR_RESULTS", },
    { recipe = "TARGET_COMBINATOR_PROGRAM_RECIPE",        result = "TARGET_COMBINATOR_PROGRAM_RESULTS", },
    { recipe = "TARGET_COMBINATOR_REFORMAT_SLOW_RECIPE",  result = "TARGET_COMBINATOR_REFORMAT_SLOW_RESULTS", },
    { recipe = "TARGET_COMBINATOR_REFORMAT_DIRTY_RECIPE", result = "TARGET_COMBINATOR_REFORMAT_DIRTY_RESULTS", },
    { recipe = "TARGET_COMBINATOR_REFORMAT_ACID_RECIPE",  result = "TARGET_COMBINATOR_REFORMAT_ACID_RESULTS", },
...
for _, setting in ipairs({
    ...
    { prerequisites = "ROCKET_RECOVERABILITY_RESEARCH_PREREQUISITES",   ingredients = "ROCKET_RECOVERABILITY_RESEARCH_INGREDIENTS", },
    { prerequisites = "ROCKET_RECOVERABILITY_2_RESEARCH_PREREQUISITES", ingredients = "ROCKET_RECOVERABILITY_2_RESEARCH_INGREDIENTS", },
    { prerequisites = "ROCKET_RECOVERABILITY_3_RESEARCH_PREREQUISITES", ingredients = "ROCKET_RECOVERABILITY_3_RESEARCH_INGREDIENTS", },
}) do
