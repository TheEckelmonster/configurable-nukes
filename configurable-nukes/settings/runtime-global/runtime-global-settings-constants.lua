...
runtime_global_settings_constants.settings = {
    DO_MAP_REVEAL = {
        type = "bool-setting",
        name = prefix .. "do-map-reveal-runtime",
    ...
    --[[ ICBM ]]
    PAYLOAD_BASE_DAMAGE_MODIFIER = {
        type = "double-setting",
        name = prefix .. "payload-base-damage-modifier",
        setting_type = "runtime-global",
        order = "",
        default_value = 1,
        minimum_value = 1,
    ...
    PAYLOAD_BASE_DAMAGE_ADDITION = {
        type = "double-setting",
        name = prefix .. "payload-base-damage-addition",
        setting_type = "runtime-global",
        order = "",
        default_value = 0,
        minimum_value = 0,
    ...
    PAYLOAD_BONUS_DAMAGE_MODIFIER = {
        type = "double-setting",
        name = prefix .. "payload-bonus-damage-modifier",
        setting_type = "runtime-global",
        order = "",
        default_value = 1,
        minimum_value = 1,
    ...
    PAYLOAD_BONUS_DAMAGE_ADDITION = {
        type = "double-setting",
        name = prefix .. "payload-bonus-damage-addition",
        setting_type = "runtime-global",
        order = "",
        default_value = 0,
        minimum_value = 0,
    ...
    ROCKET_SILOS_PROCESSING_MODE = {
        type = "string-setting",
        name = prefix .. "circuit-launched-rocket-silos-performance-mode",
        setting_type = "runtime-global",
        order = "",
        default_value = "responsive",
        allowed_values = { "responsive", "balance", "performance", },
        allow_blank = true,
    },
    ROCKET_SILO_PROCESSING_RATE = {
        type = "int-setting",
        name = prefix .. "rocket-silo-processing-rate",
        setting_type = "runtime-global",
        order = "",
        default_value = 6,
        minimum_value = 1,
    ...
    NUM_ROCKET_SILOS_PROCESSED_PER_TICK = {
        type = "int-setting",
        name = prefix .. "num-rocket-silos-processed-per-tick",
        setting_type = "runtime-global",
        order = "",
