...
local recipe_payloader =
{
    ...
    results = {{ type = "item", name = "payloader", amount = Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.PAYLOADER_RESULT_COUNT.name }) }},
    category = Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.PAYLOADER_CRAFTING_MACHINE.name }),
    additional_categories = get_payloader_additional_crafting_machines(),
