...
local recipe =
{
    ...
    ingredients = Setting_Utils.get_recipe_ingredients({
        recipe_setting = Startup_Settings_Constants.settings.TESLA_ROCKET_RECIPE,
    }) or Startup_Settings_Constants.settings.TESLA_ROCKET_RECIPE.ingredients,
    -- results = {{ type = "item", name = "atomic-bomb", amount = Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.TESLA_ROCKET_RESULT_COUNT.name }) }},
    results = Setting_Utils.get_recipe_results({
        recipe_setting = Startup_Settings_Constants.settings.TESLA_ROCKET_RESULTS,
    }) or Startup_Settings_Constants.settings.TESLA_ROCKET_RESULTS.results,
    category = Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.TESLA_ROCKET_CRAFTING_MACHINE.name }),
    ...
    additional_categories = Setting_Utils.get_additional_crafting_machines({
        default_value = Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.TESLA_ROCKET_ADDITIONAL_CRAFTING_MACHINES.name }),
    }),
}
