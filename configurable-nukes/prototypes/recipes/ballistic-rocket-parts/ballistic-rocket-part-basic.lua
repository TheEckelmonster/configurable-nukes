...
--     return Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.BALLISTIC_ROCKET_PART_INPUT_MULTIPLIER.name })
-- end
...
-- local ingredients = {}
-- local ballistic_rocket_part_recipe_string = Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.BALLISTIC_ROCKET_PART_RECIPE.name, default_value = "" })
...
-- if (not Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.BALLISTIC_ROCKET_PART_RECIPE_ALLOW_NONE.name })) then
...
-- ipbm_rocket_part_basic.name = Startup_Settings_Constants.settings.BALLISTIC_ROCKET_PART_RECIPE.recipe_name
-- ipbm_rocket_part_basic.name = Startup_Settings_Constants.settings.BALLISTIC_ROCKET_PART_RECIPE.name
...
-- ipbm_rocket_part_basic.results = {{ type = "item", name = "ipbm-rocket-part", amount = Data_Utils.get_startup_setting({ setting = Startup_Settings_Constants.settings.BALLISTIC_ROCKET_PART_RESULT_COUNT.name }) }}
