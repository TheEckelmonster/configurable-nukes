...
table.insert(galvanic_lightning_bolt_2.action_delivery, 1,  {
    type = "chain",
    chain = galvanic_chain_name .. "-2" .. "-normal",
    repeat_count = 5,
    probability = base_lightning_bolt_probability,
})

-- table.insert(galvanic_lightning_bolt_1_target_effects_1, 1, {
--     -- type = "nested-result",
--     -- action = {
--     --     {
--     --         type = "direct",
...
-- table.insert(galvanic_beam_2.action.action_delivery.target_effects,
-- {
--     type = "nested-result",
--     probability = 0.025,
--     action = {
...
--     -- },
-- })
-- table.insert(galvanic_chain.action, 2, galvanic_lightning_bolt_2)
...
-- local tesla_rocket = data.raw["projectile"][name .. "-normal"]
-- log(serpent.block(tesla_rocket))

-- local tesla_rocket_shockwave = data.raw["projectile"][name .. "-shockwave-normal"]

-- table.insert(tesla_rocket_shockwave.action, 1, galvanic_lightning_bolt)

-- local tesla_rocket_chain = data.raw["chain-active-trigger"][name .. "-chain-normal"]

-- log(serpent.block(tesla_rocket_chain))

-- tesla_rocket_chain.action[1] = galvanic_lightning_bolt
