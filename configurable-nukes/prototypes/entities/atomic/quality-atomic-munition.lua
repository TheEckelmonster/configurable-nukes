            ...
            if (params.fire_wave) then
                local fire_wave = create_fire_wave(
                    ...
                    k_0,
                    {
                        ...
                        maximum_spread_count = params.fire_wave.maximum_spread_count,
                        pollution = params.fire_wave.pollution,
                        base_lifetime = params.fire_wave.base_lifetime,
                        initial_lifetime = params.fire_wave.initial_lifetime,
                        maximum_lifetime = params.fire_wave.maximum_lifetime,
                        num_levels = params.fire_wave.num_levels,
                        max_num_levels = params.fire_wave.max_num_levels,
                        min_num_levels = params.fire_wave.min_num_levels,
                    }
                )
