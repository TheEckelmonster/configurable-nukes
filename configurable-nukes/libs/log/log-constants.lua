...
if _log_constants and _log_constants.configurable_nukes then
...
log_constants.settings.DEBUG_LEVEL.name = "configurable-nukes-debug-level"

log_constants.settings.DO_NOT_PRINT = {
  type = "bool-setting",
  name = "configurable-nukes-do-not-print",
...
log_constants.settings.DO_TRACEBACK = {
  type = "bool-setting",
  name = "configurable-nukes-do-traceback",
  setting_type = "runtime-global",
  order = "abc",
  default_value = false
}

log_constants.configurable_nukes = true
